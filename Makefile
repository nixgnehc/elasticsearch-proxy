...
FRAMEWORK_REPO := https://github.com/medcl/github.com/nixgnehc/infini-framework.git
FRAMEWORK_BRANCH := master
FRAMEWORK_VENDOR_FOLDER := $(CURDIR)/vendor/
FRAMEWORK_VENDOR＿REPO :=  https://github.com/medcl/github.com/nixgnehc/infini-framework-vendor.git
